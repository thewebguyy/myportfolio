...
export const principles: Principle[] = [
...

  {
    ...
    incident: 'ServiceBridge was built for West Africa. The first constraint was that the network is not what the spec assumed.',
    body: [
      'ServiceBridge connects skilled tradespeople with homeowners across West Africa. The specification, from day one, was different: a payment provider webhook arriving 40 seconds late is not a bug report — it is the network. A mobile connection dropping mid-request is not an edge case — it is the median user experience. Treating these as exceptions would have produced a system that worked in a Lagos office on fibre and failed everywhere else. The first architectural decision was to stop treating them as exceptions.',
...

  {
    ...
    citations: [
      ...
      },
      {
        ...
        projectTitle: 'Checkout System',
        category: 'API Integration',
        year: 2023,
        duration: '4 weeks',
        role: 'Solo (Contract — Seerbit)',
        claim: 'Zero-downtime deployment pipeline with automated rollback on error rate threshold breach.',
